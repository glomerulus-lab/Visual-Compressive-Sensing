...
from .gaussian_width import full_NSP, diag_sampling_NSP, diag_analytic_NSP
...
width_mean, width_se, width_samples = full_NSP(d, S, rho, cov, NUM_SAMPLES)
print(f"w_full (C) estimate at r = 1: {width_mean:.4f}, dim: {width_mean ** 2:.1f}")
width_mean, width_se, width_samples = diag_sampling_NSP(d, S, rho, cov_diag, NUM_SAMPLES)
print(f"w_diag (C) estimate at r = 1: {width_mean:.4f}, dim: {width_mean ** 2:.1f}")
width_analytic, _ = diag_analytic_NSP(d, S, rho, cov_diag)
